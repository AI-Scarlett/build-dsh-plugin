# Build DSH Plugin 0.4.3 validation
...
Automated validation: 18 tests; `npm run check plus brief, marketplace, candidate and distribution checks`. Package entrypoints were checked with `npm pack --dry-run --ignore-scripts`.
