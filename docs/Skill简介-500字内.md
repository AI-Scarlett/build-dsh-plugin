...
`build-dsh-plugin` 0.3.1 是面向 DeepSeek Harness（DSH）插件开发的 Agent Skill，并提供已针对 DSH `0.1.1-rc.2` 验证的原生 Skill Provider Bundle。用户只需说明“问题、结果、成功标准”，即可生成标准 Bundle、rc.5–rc.8、`0.1.1-rc.1` 与 `0.1.1-rc.2` 兼容和操作证据矩阵、权限矩阵、测试、审计和验收流程。
