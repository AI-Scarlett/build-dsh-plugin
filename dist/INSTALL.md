...
- `build-dsh-plugin-20260905.1.zip`：完整 Skill，ZIP 顶层是 `build-dsh-plugin/`。
- `build-dsh-plugin-20260905.1.sha256`：ZIP 完整性校验。
- `manifest.json`：版本、入口、依赖、校验状态和明确排除项。

固定发行页：<https://github.com/AI-Scarlett/build-dsh-plugin/releases/tag/v2026.09.05.1>
...
unzip -l build-dsh-plugin-20260905.1.zip
```

期望 SHA-256：

```text
57992de93d2252c44e6ca7dde0a6446c6cee3a9484dd93031cda6e9119f2a38a
```
