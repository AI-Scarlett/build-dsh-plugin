...
test('repository root is a lifecycle-free DSH Skill adapter', async () => {
  ...
  assert.equal(pkg.dsh.compatibility.dsh, '>=0.1.0-rc.8 <0.2.0 || 0.1.3-alpha.1')
  for (const release of ['0.1.2-alpha.5', '0.1.2-rc.1', '0.1.3-alpha.1']) {
...
test('mounted Skill declares DSH and card-contract workflows', async () => {
  ...
  assert.deepEqual(Object.keys(catalog.compatibility.dshOperations), ['0.1.2-alpha.5', '0.1.2-rc.1', '0.1.3-alpha.1'])
