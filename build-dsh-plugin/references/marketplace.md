...
- `compatibility.dshReleases` explicitly marks the public `rc.7`, `rc.8` keys plus full-version keys `0.1.1-rc.1` and `0.1.1-rc.2` as `compatible`, `incompatible`, or `unknown`; removed rc.5/rc.6 aliases must not be generated. Derive it from the declared range and keep unknown evidence visible.
