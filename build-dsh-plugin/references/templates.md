...
- [ ] rc.7–rc.8 plus `0.1.1-rc.1` and `0.1.1-rc.2` install/start/uninstall/rollback evidence matrix is explicit
...
- rc.7–rc.8 plus `0.1.1-rc.1` and `0.1.1-rc.2` operation evidence: install/start/uninstall/rollback matrix
